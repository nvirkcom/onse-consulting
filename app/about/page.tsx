      ...
      <div className="flex flex-col gap-16 max-w-[1320px] mt-20 mx-auto px-4 py-16">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              We apply and deliver our services in respect of: Section 35 of the
              Constitution Act; the Truth and Reconciliation’s Calls to Action;
              and the United Nations Declaration on the Rights of Indigenous
              Peoples. We acknowledge the unique status, treaty rights and
              diverse governance systems of First Nations, Métis and Inuit
              peoples and communities in Canada and will work in partnership
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ONSE recognizes the importance of protocols, Indigenous worldviews
              and creating a space for respectful dialogue while incorporating
              cultural and traditional approaches and processes in progressing
              our projects and initiatives. We provide strong due-diligence in
              ensuring our clients and partners understand that providing a
              culturally rich and inclusive environment can lead to successful
        ...
        <div className="flex flex-col gap-8">
          <Figure
            caption={{
              english: "Antigua, Sacatepéquez, Guatemala",
              native: "Hunapú (Kakchikel Mayas)",
            }}
          >
            <Image
