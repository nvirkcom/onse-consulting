...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="2xl:px-0 flex flex-col gap-8 lg:px-8 max-w-[1320px] md:px-4 mx-auto px-4 py-16 relative z-20">
        <div className="flex flex-col gap-2 md:w-1/2 xl:w-1/3">
          <h2 className={`${bodoniModa.className} text-[#ed1b24] text-2xl`}>
            Land Acknowledgement
          </h2>
          <p>
            ONSE Consulting is located in the ancestral, unceded and traditional
            territory of the Coast Salish peoples, specifically the Skwxwú7mesh
            (Squamish), Səl̓ílwətaʔ/Selilwitulh (Tsleil-Waututh), and xwməθkwəy̓əm
            (Musqueam) Nations.
          </p>
          <p>
            ...
            governance, languages and cultures of First Nations, Métis and Inuit
            across Canada.
          </p>
        </div>
